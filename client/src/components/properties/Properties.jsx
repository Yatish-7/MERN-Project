...
import img1 from '../../assets/front.jpeg'
...
const Properties = () => {
  ...
  const viewCounter = (property) => {
    property.views = property.views ? property.views + 1 : 1;
    console.log(`${property.title} has ${property.views} views.`);
    return property;
  };
            ...
            <div className={classes.properties}>
              {filteredProperties.map((property) => (
                <div key={property._id} className={classes.property}>
                  <Link to={`/propertyDetail/${property._id}`} className={classes.imgContainer} onClick={() => viewCounter(property)} >
                    <img src={`http://localhost:8000/images/${property?.img}`} alt="" />
                  </Link>
                  ...
                  <div className={classes.details}>
                    ...
                    <div className={classes.moreDetails}>
                      ...
                      <span>{property.views} views <FaEye className={classes.icon}/></span>
                      <span>{property.rating}/5 rating <FaSmile className={classes.icon}/></span>
                    </div>
